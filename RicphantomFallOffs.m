...
% use (20 mm,) (50 mm,) 60mm, 100 mm, 150 mm, 200 mm, 250 mm depth, water tank starts at y = 151
A = zeros(500,500,500);
A(241:260,341:360,241:260) = 1; % middle of water tank y = 291:310 (150 mm depth)
ix = find(A > 0);
cst{2,4}{1} = ix;
cst{2,5}.visibleColor = [0 1 1];
...
% use (20 mm,) (50 mm,) 60mm, 100 mm, 150 mm, 200 mm, 250 mm depth, water tank starts at y = 151
A = zeros(500,500,500);
A(241:260,291:310,241:260) = 1; % middle of water tank y = 291:310 (150 mm depth)
ix = find(A > 0);
cst{2,4}{1} = ix;
cst{2,5}.visibleColor = [0 1 1];
...
% use (20 mm,) (50 mm,) 60mm, 100 mm, 150 mm, 200 mm, 250 mm depth, water tank starts at y = 151
A = zeros(500,500,500);
A(241:260,241:260,241:260) = 1; % middle of water tank y = 291:310 (150 mm depth)
ix = find(A > 0);
cst{2,4}{1} = ix;
cst{2,5}.visibleColor = [0 1 1];
...
% use (20 mm,) (50 mm,) 60mm, 100 mm, 150 mm, 200 mm, 250 mm depth, water tank starts at y = 151
A = zeros(500,500,500);
A(241:260,201:220,241:260) = 1; % middle of water tank y = 291:310 (150 mm depth)
ix = find(A > 0);
cst{2,4}{1} = ix;
cst{2,5}.visibleColor = [0 1 1];
...
% use (20 mm,) (50 mm,) 60mm, 100 mm, 150 mm, 200 mm, 250 mm depth, water tank starts at y = 151
A = zeros(500,500,500);
A(241:260,191:210,241:260) = 1; % middle of water tank y = 291:310 (150 mm depth)
ix = find(A > 0);
cst{2,4}{1} = ix;
cst{2,5}.visibleColor = [0 1 1];
...
% use (20 mm,) (50 mm,) 60mm, 100 mm, 150 mm, 200 mm, 250 mm depth, water tank starts at y = 151
A = zeros(500,500,500);
A(241:260,161:180,241:260) = 1; % middle of water tank y = 291:310 (150 mm depth)
ix = find(A > 0);
cst{2,4}{1} = ix;
cst{2,5}.visibleColor = [0 1 1];
