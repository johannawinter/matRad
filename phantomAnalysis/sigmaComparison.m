...
legend(ax1,'degradation - P_{mod,min} = 50 µm',...
    'degradation - P_{mod,rep} = 256 µm','degradation - P_{mod,max} = 750 µm',...
    ['RS (fit) - ' num2str(breastThickness(1)) ' mm water'],...
    ['RS (fit) - ' num2str(breastThickness(2)) ' mm water'],...
    ['RS (fit) - ' num2str(breastThickness(3)) ' mm water'],... %     ['RS (base data) - ' num2str(breastThickness(4)) ' mm water'],...
    ['RS (theo) - ' num2str(breastThickness(1)) ' mm water'],...
    ['RS (theo) - ' num2str(breastThickness(2)) ' mm water'],...
    ['RS (theo) - ' num2str(breastThickness(3)) ' mm water'],... %     ['RS (theoretical)  - water thickness ' num2str(breastThickness(4)) ' mm'],...
